...
public class AdministratorService {
    ...
    @POST
    @Path("/")
    public Response createNewPatient (AdministratorDTO administratorDTO)throws MyEntityExistsException, MyEntityNotFoundException, MyConstraintViolationException {
